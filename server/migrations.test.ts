...
beforeAll(async () => {
  ...
  await db.migrate.rollback(null, true); // reset all
...
describe('Migrations', () => {
  ...
  it('preserves data during migration', async () => {
    ...
    await db.migrate.up('20250502153508_create_way_qualities_table');
    ...
    await db.migrate.down('20250502153508_create_way_qualities_table');
